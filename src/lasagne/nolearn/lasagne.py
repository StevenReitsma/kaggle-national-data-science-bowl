...
class NeuralNet(BaseEstimator):
    ...
    def train_loop(self, X, y):
        ...
        if self.verbose:
            print("""
 Epoch  |  Train loss  |  Valid loss  |  Train / Val  |  Valid acc  |        Dur  |        LR    
--------|--------------|--------------|---------------|-------------|-------------|------------\
""")
            ...
            if self.verbose:
                ...
                print(" {:>5}  |  {}{:>10.6f}{}  |  {}{:>10.6f}{}  "
                      "|  {:>11.6f}  |  {:>9}  |  {:>8.1f}s  |  {:>3.8f}".format(
                          ...
                          time() - t0,
                          float(np.array(self.update_learning_rate.eval()))
                          ))
    ...
    def train_test_split(self, X, y, eval_size):
        if eval_size:
            ...
            X_train, y_train = X, y
            X_valid, y_valid = X[0.9*len(X):], y[0.9*len(y):]
