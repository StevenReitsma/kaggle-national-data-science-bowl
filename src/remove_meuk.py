...
def remove_meuk(self, size = 256, image_dir = 'I:/AI_for_an_eyes/test/test/', target_dir = 'I:/AI_for_an_eyes/test/test_zonder_meuk_256/'):
...
if __name__ == '__main__':
    ...
    remove_meuk(size = size, image_dir = image_dir, target_dir = target_dir)